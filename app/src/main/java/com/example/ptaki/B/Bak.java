...
public class Bak extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BąkStatus";
    public static final String TEXT2 = "BąkNotatka";
    public static final String TEXT3 = "BąkZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BąkDataZłapania";
    public static final String LOKALIZACJA = "BąkMiejsceZłapania";
    public static final String MAZDJĘCIE = "BąkMaZdjęcie";
    public static final String ZDJĘCIE = "BąkZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.imgViewBąkUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bak.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BąkNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bak.this);
