...
public class Bialorzytka_saharyjska extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BiałorzytkaSaharyjskaStatus";
    public static final String TEXT2 = "BiałorzytkaSaharyjskaNotatka";
    public static final String TEXT3 = "BiałorzytkaSaharyjskaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BiałorzytkaSaharyjskaDataZłapania";
    public static final String LOKALIZACJA = "BiałorzytkaSaharyjskaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BiałorzytkaSaharyjskaMaZdjęcie";
    public static final String ZDJĘCIE = "BiałorzytkaSaharyjskaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bialorzytka_saharyjska);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBiałorzytkaSaharyjskaUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bialorzytka_saharyjska.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BiałorzytkaSaharyjskaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bialorzytka_saharyjska.this);
