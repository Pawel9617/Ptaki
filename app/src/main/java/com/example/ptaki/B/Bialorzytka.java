...
public class Bialorzytka extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BiałorzytkaStatus";
    public static final String TEXT2 = "BiałorzytkaNotatka";
    public static final String TEXT3 = "BiałorzytkaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BiałorzytkaDataZłapania";
    public static final String LOKALIZACJA = "BiałorzytkaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BiałorzytkaMaZdjęcie";
    public static final String ZDJĘCIE = "BiałorzytkaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bialorzytka);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBiałorzytkaUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bialorzytka.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BiałorzytkaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bialorzytka.this);
