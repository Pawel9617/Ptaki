...
public class Bernikla_kanadyjska extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BerniklaKanadyjskaStatus";
    public static final String TEXT2 = "BerniklaKanadyjskaNotatka";
    public static final String TEXT3 = "BerniklaKanadyjskaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BerniklaKanadyjskaDataZłapania";
    public static final String LOKALIZACJA = "BerniklaKanadyjskaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BerniklaKanadyjskaMaZdjęcie";
    public static final String ZDJĘCIE = "BerniklaKanadyjskaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bernikla_kanadyjska);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBerniklaKanadyjskaUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bernikla_kanadyjska.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BerniklaKanadyjskaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bernikla_kanadyjska.this);
