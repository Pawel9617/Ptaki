...
public class Bialorzytka_pstra extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BiałorzytkaPstraStatus";
    public static final String TEXT2 = "BiałorzytkaPstraNotatka";
    public static final String TEXT3 = "BiałorzytkaPstraZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BiałorzytkaPstraDataZłapania";
    public static final String LOKALIZACJA = "BiałorzytkaPstraMiejsceZłapania";
    public static final String MAZDJĘCIE = "BiałorzytkaPstraMaZdjęcie";
    public static final String ZDJĘCIE = "BiałorzytkaPstraZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bialorzytka_pstra);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBiałorzytkaPstraUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bialorzytka_pstra.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BiałorzytkaPstraNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bialorzytka_pstra.this);
