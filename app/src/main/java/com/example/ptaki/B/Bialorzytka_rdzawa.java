...
public class Bialorzytka_rdzawa extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BiałorzytkaRdzawaStatus";
    public static final String TEXT2 = "BiałorzytkaRdzawaNotatka";
    public static final String TEXT3 = "BiałorzytkaRdzawaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BiałorzytkaRdzawaDataZłapania";
    public static final String LOKALIZACJA = "BiałorzytkaRdzawaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BiałorzytkaRdzawaMaZdjęcie";
    public static final String ZDJĘCIE = "BiałorzytkaRdzawaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bialorzytka_rdzawa);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBiałorzytkaRdzawaUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bialorzytka_rdzawa.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BiałorzytkaRdzawaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bialorzytka_rdzawa.this);
