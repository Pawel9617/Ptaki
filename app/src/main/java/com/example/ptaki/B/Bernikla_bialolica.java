...
public class    Bernikla_bialolica extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BerniklaBiałolicaStatus";
    public static final String TEXT2 = "BerniklaBiałolicaNotatka";
    public static final String TEXT3 = "BerniklaBiałolicaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BerniklaBiałolicaDataZłapania";
    public static final String LOKALIZACJA = "BerniklaBiałolicaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BerniklaBiałolicaMaZdjęcie";
    public static final String ZDJĘCIE = "BerniklaBiałolicaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bernikla_bialolica);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBerniklaBiałolicaUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bernikla_bialolica.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BerniklaBiałolicaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bernikla_bialolica.this);
