...
public class Bernikla_obrozna extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BerniklaObrożnaStatus";
    public static final String TEXT2 = "BerniklaObrożnaNotatka";
    public static final String TEXT3 = "BerniklaObrożnaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BerniklaObrożnaDataZłapania";
    public static final String LOKALIZACJA = "BerniklaObrożnaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BerniklaObrożnaMaZdjęcie";
    public static final String ZDJĘCIE = "BerniklaObrożnaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bernikla_obrozna);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBerniklaObrożnaUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bernikla_obrozna.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BerniklaObrożnaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bernikla_obrozna.this);
