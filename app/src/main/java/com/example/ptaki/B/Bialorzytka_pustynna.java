...
public class Bialorzytka_pustynna extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BiałorzytkaPustynnaStatus";
    public static final String TEXT2 = "BiałorzytkaPustynnaNotatka";
    public static final String TEXT3 = "BiałorzytkaPustynnaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BiałorzytkaPustynnaDataZłapania";
    public static final String LOKALIZACJA = "BiałorzytkaPustynnaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BiałorzytkaPustynnaMaZdjęcie";
    public static final String ZDJĘCIE = "BiałorzytkaPustynnaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bialorzytka_pustynna);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBiałorzytkaPustynnaUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Bialorzytka_pustynna.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BiałorzytkaPustynnaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bialorzytka_pustynna.this);
