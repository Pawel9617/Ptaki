...
public class Bernikla_rdzawoszyja extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "BerniklaRdzawoszyjaStatus";
    public static final String TEXT2 = "BerniklaRdzawoszyjaNotatka";
    public static final String TEXT3 = "BerniklaRdzawoszyjaZłapany";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String DATAZŁAPANIA = "BerniklaRdzawoszyjaDataZłapania";
    public static final String LOKALIZACJA = "BerniklaRdzawoszyjaMiejsceZłapania";
    public static final String MAZDJĘCIE = "BerniklaRdzawoszyjaMaZdjęcie";
    public static final String ZDJĘCIE = "BerniklaRdzawoszyjaZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bernikla_rdzawoszyja);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewBerniklaRdzawoszyjaUżytkownika);
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.BerniklaRdzawoszyjaNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Bernikla_rdzawoszyja.this);
