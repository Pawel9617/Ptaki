...
public class Alczyk extends AppCompatActivity implements  View.OnClickListener{

    public static final String SHARED_PREFS = "sharedPrefs";
    public static final String TEXT = "AlczykStatus";
    public static final String TEXT2 = "AlczykNotatka";
    public static final String TEXT3 = "AlczykZłapany";
    public static final String DATAZŁAPANIA = "AlczykDataZłapania";
    public static final String LOKALIZACJA = "AlczykMiejsceZłapania";
    public static final String TEXT4 = "LiczbaZnalezionych";
    public static final String MAZDJĘCIE = "AlczykMaZdjęcie";
    public static final String ZDJĘCIE = "AlczykZdjęcie;";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alczyk);
        tvStatus = (TextView)findViewById(R.id.txtViewStatus);
        bMamGo = (Button)findViewById(R.id.bMamGo);
        bMamGo.setOnClickListener(this);
        imageView = findViewById(R.id.imgViewAlczykUżytkownika);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //getImageFromGallery();
                Toast.makeText(Alczyk.this, "Funkcja niedostępna", Toast.LENGTH_SHORT).show();
            }
        });
        loadData();
        updateViews();
    ...
    protected void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        EditText editText = findViewById(R.id.AlczykNotatka);
    ...
    public void getLocation(View view){
        gpsTracker = new GpsTracker(Alczyk.this);
